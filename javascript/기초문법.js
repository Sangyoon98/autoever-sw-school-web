...
// var : 예전에 사용한 방식 (사용 금지), 호이스팅이 일어남

console.log(temp);
var temp = 100;

// 템플릿 문자열 : ES6에서 추가된 문법
// 자바스크립트는 문자열을 출력 할 때 "", '', 구분하지 않음
const name = "장원영";
const age = 22;
...
// 배열 : 동일한 데이터 타입(X) 연속된 공간에 저장되는 방식, 인덱스를 가지고 값을 찾는 방식, (O(1))
const arr1 = [
  "아이브",
  "안유진",
  20,
...
// 객채는 객체 타입 : 개체 타입이라는 주소를 참조하는 타입
const person1 = person; // 주소에 대한 참조 복사
person1.name = "하니";
person1.addr.city = "베트남, 호주";
